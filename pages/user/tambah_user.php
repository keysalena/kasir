...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">TAMBAH USER RESTO</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="pages/user/tambah_user_proses.php">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="id_level" id=id_level class="form-control pencarian" required>
                </div> 
