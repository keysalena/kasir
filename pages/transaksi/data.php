              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['nomeja']; ?></td>
                    <td><?php echo $row['tanggal']; ?></td>
                    <td>Rp <?php echo number_format($total_bayar, 0, ',', '.'); ?></td>
                    <td>
                      <a href="pages/transaksi/hapus.php?id=<?= $row['id_transaksi']; ?>" class="btn btn-danger" role="button" title="Hapus Data" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
