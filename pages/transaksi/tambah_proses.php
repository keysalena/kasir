...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($insertQuery) {
        echo "<script>alert('Pesanan berhasil ditambahkan.'); window.location.href = '../../index.php?page=data_transaksi';</script>";
    } else {
        echo "<script>alert('Gagal menambahkan pesanan. Silakan coba lagi.'); window.location.href = '../../index.php?page=data_transaksi';</script>";
    }
}
