              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="pages/detail/hapus.php?id=<?= $row['id_order']; ?>" class="btn btn-danger" role="button" title="Hapus Data" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
