...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($existingOrderQuery) > 0) {
        ...
        if ($insertQuery) {
            echo "<script>alert('Pesanan berhasil ditambahkan.'); window.location.href = '../../index.php?page=data_order';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan pesanan. Silakan coba lagi.'); window.location.href = '../../index.php?page=data_order';</script>";
        }
    }
}
