<?php
$query = mysqli_query($koneksi, "SELECT * FROM `order` WHERE id_order='" . $_GET['id'] . "'")
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" method="post" action="pages/order/ubah_proses.php">
            <div class="box-body">
