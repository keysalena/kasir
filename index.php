            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Melany Ayu Lestari</span>
                </a>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p>Melany Ayu Lestari</p>
              <a href="#"><i class="fa fa-circle text-success"></i> PROJEK UKK: Kasir Resto</a>
            </div>
          </div>
          <!-- search form -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="glyphicon glyphicon-briefcase"></i> <span>Data Resto</span>
            ...
            <li class="treeview">
              <a href="#">
                <i class="glyphicon glyphicon-briefcase"></i> <span>Transaksi</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="index.php?page=data_order"><i class="glyphicon glyphicon-education"></i> <span>Data Order</span></a></li>
                <li><a href="index.php?page=data_detail"><i class="glyphicon glyphicon-education"></i> <span>Data Detail Order</span></a></li>
                <li><a href="index.php?page=data_transaksi"><i class="glyphicon glyphicon-education"></i> <span>Data Transaksi</span></a></li>
              </ul>
            </li>
            <li><a href="index.php?page=data_pesan"><i class="glyphicon glyphicon-briefcase"></i> <span>Pesan</span></a></li>
